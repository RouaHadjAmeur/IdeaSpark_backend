...
export class TrendingAudioService implements OnModuleInit {
  ...
  private getMockTrendingAudio(): TrendingAudioItem[] {
    return [
      { rank: 1, direction: 'new', title: 'Llayda Fell Jay (MEDU BEATS...', artist: 'MEDU', reelsCount: '6.4K reels', imageUrl: 'https://picsum.photos/200?random=1', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3' },
      { rank: 2, direction: 'new', title: 'Barra Eneramo', artist: 'Taraji Music, Curva Sud Tunis...', reelsCount: 'Popular', imageUrl: 'https://picsum.photos/200?random=2', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3' },
      { rank: 3, direction: 'new', title: 'Original audio', artist: 'httpoa_', reelsCount: '7.9K reels', imageUrl: 'https://picsum.photos/200?random=3', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3' },
      { rank: 4, direction: 'new', title: 'Original audio', artist: 'dhia_dragon', reelsCount: '32 reels', imageUrl: 'https://picsum.photos/200?random=4', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3' },
      { rank: 5, direction: 'new', title: 'OMMA', artist: 'Kaso', reelsCount: '673 reels', imageUrl: 'https://picsum.photos/200?random=5', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3' },
      { rank: 6, direction: 'new', title: 'For Real E', artist: 'Samara', reelsCount: '1.6K reels', imageUrl: 'https://picsum.photos/200?random=6', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-6.mp3' },
      { rank: 7, direction: 'new', title: 'Liberté (feat. Ouled El Bahdja) E', artist: 'Soolking', reelsCount: '60K reels', imageUrl: 'https://picsum.photos/200?random=7', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3' },
      { rank: 8, direction: 'new', title: 'Nouara', artist: 'Cheb Aïssa', reelsCount: '599 reels', imageUrl: 'https://picsum.photos/200?random=8', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-8.mp3' },
      { rank: 9, direction: 'new', title: 'Beauty And A Beat (feat. Nicki Minaj)', artist: 'Justin Bieber', reelsCount: '343K reels', imageUrl: 'https://picsum.photos/200?random=9', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-9.mp3' },
      { rank: 10, direction: 'new', title: 'Basrah w Atooh', artist: 'Cairokee', reelsCount: '96K reels', imageUrl: 'https://picsum.photos/200?random=10', previewUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3' },
    ];
  }
}
